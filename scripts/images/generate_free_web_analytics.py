...
card_featured(
    c, ACCENT,
    initials = "G4",
    logo     = logo_path("google-analytics.png"),
...
card_grid(c, [
    ("#3b82f6", "SC", "Search Console",    "Google Search queries, clicks, and CTR", logo_path("search-console.png")),
    ("#06b6d4", "Cl", "Microsoft Clarity", "Heatmaps and session replays beside GA4", logo_path("clarity.png")),
    ("#8b5cf6", "Um", "Umami",             "Privacy-friendly analytics you host", logo_path("umami.png")),
    ("#eab308", "Ma", "Matomo",            "Detailed self-hosted reports, paid plugins", logo_path("matomo.png")),
])
