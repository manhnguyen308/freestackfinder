...
card_grid(c, [
    ("#ef4444", "Zo", "Zoho CRM Free",   "Classic sales workflow for up to three users"),
    ("#3b82f6", "Fs", "Freshsales Free", "Visual pipeline with built-in email and phone"),
    ("#06b6d4", "Bx", "Bitrix24 Free",   "CRM plus tasks and chat, unclear user cap"),
    ("#64748b", "$",  "Paid CRM",        "When seats, records, or automation run out"),
])
