...
card_grid(c, [
    ("#f97316", "Cl", "Claude free",       "Long documents and edits with many constraints", logo_path("claude.png")),
    ("#3b82f6", "Co", "Microsoft Copilot", "Web-grounded writing inside Microsoft services", logo_path("microsoft-copilot.png")),
    ("#22c55e", "Ry", "Rytr",              "Short-form templates, 10,000 characters a month", logo_path("rytr.png")),
    ("#eab308", "Ge", "Google Gemini",     "Drafting connected to Google services", logo_path("google-gemini.png")),
])
