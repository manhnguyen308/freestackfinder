...
card_grid(c, [
    ("#3b82f6", "Mb", "Malwarebytes", "On-demand second opinion, no real-time on free"),
    ("#f97316", "Av", "Avast Free",   "Feature-rich, with a data collection history"),
    ("#22c55e", "AV", "AVG Free",     "Same engine and parent company as Avast"),
    ("#ef4444", "Bd", "Bitdefender",  "Focused real-time protection on Windows"),
])
