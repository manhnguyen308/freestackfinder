...
card_grid(c, [
    ("#3b82f6", "Sc", "Shotcut",     "Best for difficult source formats and codecs", logo_path("shotcut.png")),
    ("#22c55e", "OS", "OpenShot",    "Simple projects with the easiest learning curve", logo_path("openshot.png")),
    ("#f97316", "Bl", "Blender VSE", "For Blender users and motion graphics work", logo_path("blender.png")),
    ("#64748b", "Ol", "Olive",       "Worth tracking, not production-ready yet", logo_path("olive.png")),
])
