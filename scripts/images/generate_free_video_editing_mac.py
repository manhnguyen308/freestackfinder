...
card_grid(c, [
    ("#3b82f6", "DR", "DaVinci Resolve", "Full timeline, color, and audio, no watermark"),
    ("#22c55e", "Cc", "CapCut Desktop",  "Short social clips with auto captions"),
    ("#8b5cf6", "Kd", "Kdenlive",        "Open-source multi-track, separate Mac builds"),
    ("#eab308", "Sc", "Shotcut",         "Broad format support for unusual codecs"),
])
