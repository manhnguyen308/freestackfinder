...
card_grid(c, [
    ("#ef4444", "ZI", "Zoho Invoice",     "Client portal, 2 users, 500 invoices a year"),
    ("#3b82f6", "IN", "Invoice Ninja",    "Project billing for up to 5 hosted clients"),
    ("#64748b", "Sq", "Square Invoices",  "Service businesses taking card payments"),
    ("#8b5cf6", "St", "Stripe Invoicing", "0.4% per paid Starter invoice, plus processing"),
])
