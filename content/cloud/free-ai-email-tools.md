...
- Positivity, politeness, and subjectivity scores require a Pro or Premium plan
- No mobile app
...
Respondable's basic meter is not charged against the ten monthly scheduling credits. Boomerang's [Respondable FAQ](https://help.boomeranggmail.com/article/296-respondable-advanced-features) identifies positivity, politeness, and subjectivity as advanced paid measurements.
...
Spike only makes sense here if changing email clients is acceptable:
...
rows:
  ...
  - tool: ChatGPT free
    ...
    free_limit: Limits vary by model and tool
  - tool: Boomerang
  ...
  - tool: Spike
    ...
    free_limit: "10 AI queries per feature + 1 address"
{{< /comparison-table >}}
...
The free options cover different levels of use. An upgrade may become relevant when:

- Credits or tool limits interrupt the normal workflow.
- Several people need shared features or administration.
